  ...
  <div class="donations-container">
    ...
    <el-card>
      <el-form :inline="true" class="filter-form">
        ...
        <el-form-item>
          <el-button type="primary" @click="loadDonations">查询</el-button>
        </el-form-item>
      </el-form>
      ...
      <el-table :data="donations" v-loading="loading" stripe>
        ...
        <el-table-column label="操作" width="180" fixed="right">
          <template #default="{ row }">
            <el-button link type="success" @click="handleApprove(row)" v-if="row.status === 1">
              通过
            </el-button>
            <el-button link type="danger" @click="handleReject(row)" v-if="row.status === 1">
              拒绝
            </el-button>
            <span v-else>-</span>
          </template>
